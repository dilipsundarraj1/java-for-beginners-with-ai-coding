...
public class TicketPurchaseService {
     ...
     */
    private Ticket createTicket(int age, boolean member, SeatType seatType) {
     ...
     */
    private PurchaseSummary summarize(List<Ticket> tickets) {
     ...
     */
    public PurchaseResult buyTicket(Scanner scanner) {
        System.out.println("\n=== Ticket Purchase ===");
        ...
        while (addMore) {
            ...
            Ticket ticket = createTicket(age, member, seatType);
        ...
        PurchaseSummary summary = summarize(sessionTickets);
